...
df.dropna(subset=['award_value', 'award_date'], inplace=True)
...
ax.set_title('Top 10 Government Departments by Total Procurement Spend', fontsize=13, fontweight='bold')
...
monthly = df.resample('M', on='award_date')['award_value'].sum().reset_index()
...
bins = [0, 10_000, 100_000, 1_000_000, 10_000_000, df['award_value'].max()]
